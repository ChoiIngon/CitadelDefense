...
namespace XXField
{
    ...
    {
        XX_ERROR_SUCCESS = 000000,
        XX_ERROR_ERR_ALREADY_LOGINED = 000001,
        XX_ERROR_ERR_INVALID_USER = 000002,
        XX_ERROR_ERR_ROOM_IS_NOT_WAIT = 000003,
        XX_ERROR_ERR_ROOM_IS_NOT_READY = 000004,
        XX_ERROR_ERR_ALREADY_IN_ROOM = 000006,
        XX_ERROR_ERR_NOT_HOST_USER = 000007,
        XX_ERROR_ERR_NOT_ALL_USER_READY = 000010,
        XX_ERROR_ERR_USER_IS_NOT_PLAY = 000011,
        XX_ERROR_ERR_MSGFORMAT = 900001,
        XX_ERROR_ERR_UNDEFINED = 999999,
    }; // XX_ERROR_CODE
    ...
    public class XXUnitStatInfo
    {
        ...
        public bool Store(MemoryStream _buf_)
        {
            try
            {
                _buf_.Write(BitConverter.GetBytes(HealthPoint), 0, sizeof(uint));
        ...
        public bool Load(MemoryStream _buf_)
        {
            try
            {
                ...
                HealthPoint = BitConverter.ToUInt32(_buf_.GetBuffer(), (int)_buf_.Position);
    ...
    {
        public XX_UNIT_STATE_TYPE UnitState = new XX_UNIT_STATE_TYPE();
        public XX_UNIT_SUBSTATE_TYPE UnitSubState = new XX_UNIT_SUBSTATE_TYPE();
        public XX_UNIT_DIRECTION_TYPE Direction = new XX_UNIT_DIRECTION_TYPE();
        public uint StateFrame = 0;
        ...
        public int Size()
        {
            ...
            try
            {
                nSize += XX_UNIT_STATE_TYPE_Serializer.Size(UnitState);
                nSize += XX_UNIT_SUBSTATE_TYPE_Serializer.Size(UnitSubState);
        ...
        public bool Store(MemoryStream _buf_)
        {
            try
            {
                if (false == XX_UNIT_STATE_TYPE_Serializer.Store(_buf_, UnitState)) { return false; }
                if (false == XX_UNIT_SUBSTATE_TYPE_Serializer.Store(_buf_, UnitSubState)) { return false; }
                if (false == XX_UNIT_DIRECTION_TYPE_Serializer.Store(_buf_, Direction)) { return false; }
                _buf_.Write(BitConverter.GetBytes(StateFrame), 0, sizeof(uint));
        ...
        public bool Load(MemoryStream _buf_)
        {
            try
            {
                if (false == XX_UNIT_STATE_TYPE_Serializer.Load(ref UnitState, _buf_)) { return false; }
                if (false == XX_UNIT_SUBSTATE_TYPE_Serializer.Load(ref UnitSubState, _buf_)) { return false; }
                if (false == XX_UNIT_DIRECTION_TYPE_Serializer.Load(ref Direction, _buf_)) { return false; }
                if (sizeof(uint) > _buf_.Length - _buf_.Position) { return false; }
                StateFrame = BitConverter.ToUInt32(_buf_.GetBuffer(), (int)_buf_.Position);
                _buf_.Position += sizeof(uint);
                if (sizeof(float) > _buf_.Length - _buf_.Position) { return false; }
    ...
    public class XXFieldInfo
    {
        ...
        public int Size()
        {
            ...
            {
                nSize += sizeof(int);
                if (null != FieldID) { nSize += Encoding.UTF8.GetByteCount(FieldID); }
                nSize += sizeof(int);
                if (null != Name) { nSize += Encoding.UTF8.GetByteCount(Name); }
                nSize += sizeof(int);
        ...
        public bool Store(MemoryStream _buf_)
        {
            try
            {
                if (null != FieldID)
                {
                    int FieldID_length = Encoding.UTF8.GetByteCount(FieldID);
                    _buf_.Write(BitConverter.GetBytes(FieldID_length), 0, sizeof(int));
                    _buf_.Write(Encoding.UTF8.GetBytes(FieldID), 0, FieldID_length);
                }
                else
                {
                    _buf_.Write(BitConverter.GetBytes(0), 0, sizeof(int));
        ...
        public bool Load(MemoryStream _buf_)
        {
            ...
            {
                if (sizeof(int) > _buf_.Length - _buf_.Position) { return false; }
                int FieldID_length = BitConverter.ToInt32(_buf_.GetBuffer(), (int)_buf_.Position);
                _buf_.Position += sizeof(int);
                if (FieldID_length > _buf_.Length - _buf_.Position) { return false; }
                byte[] FieldID_buf = new byte[FieldID_length];
                Array.Copy(_buf_.GetBuffer(), (int)_buf_.Position, FieldID_buf, 0, FieldID_length);
                FieldID = System.Text.Encoding.UTF8.GetString(FieldID_buf);
                _buf_.Position += FieldID_length;
                if (sizeof(int) > _buf_.Length - _buf_.Position) { return false; }
                int Name_length = BitConverter.ToInt32(_buf_.GetBuffer(), (int)_buf_.Position);
                _buf_.Position += sizeof(int);
                if (Name_length > _buf_.Length - _buf_.Position) { return false; }
    ...
    {
        public const int MSG_ID = 1;
        public XX_ERROR_CODE ErrorCode = new XX_ERROR_CODE();
        ...
        public int Size()
        {
            ...
            try
            {
                nSize += XX_ERROR_CODE_Serializer.Size(ErrorCode);
                nSize += sizeof(int);
                if (null != ErrorString) { nSize += Encoding.UTF8.GetByteCount(ErrorString); }
        ...
        public bool Store(MemoryStream _buf_)
        {
            try
            {
                if (false == XX_ERROR_CODE_Serializer.Store(_buf_, ErrorCode)) { return false; }
                if (null != ErrorString)
                {
                    int ErrorString_length = Encoding.UTF8.GetByteCount(ErrorString);
                    _buf_.Write(BitConverter.GetBytes(ErrorString_length), 0, sizeof(int));
                    _buf_.Write(Encoding.UTF8.GetBytes(ErrorString), 0, ErrorString_length);
                }
                else
                {
                    _buf_.Write(BitConverter.GetBytes(0), 0, sizeof(int));
        ...
        public bool Load(MemoryStream _buf_)
        {
            try
            {
                if (false == XX_ERROR_CODE_Serializer.Load(ref ErrorCode, _buf_)) { return false; }
                if (sizeof(int) > _buf_.Length - _buf_.Position) { return false; }
                int ErrorString_length = BitConverter.ToInt32(_buf_.GetBuffer(), (int)_buf_.Position);
                _buf_.Position += sizeof(int);
                if (ErrorString_length > _buf_.Length - _buf_.Position) { return false; }
                byte[] ErrorString_buf = new byte[ErrorString_length];
                Array.Copy(_buf_.GetBuffer(), (int)_buf_.Position, ErrorString_buf, 0, ErrorString_length);
                ErrorString = System.Text.Encoding.UTF8.GetString(ErrorString_buf);
                _buf_.Position += ErrorString_length;
    ...
    public class MsgCliSvr_Field_MoveButtonDown_Ntf
    {
        ...
        public XXVector2 Direction = new XXVector2();
        ...
        public int Size()
        {
            ...
            try
            {
                nSize += XXVector2_Serializer.Size(Direction);
                nSize += sizeof(float);
            }
            catch (System.Exception)
            {
        ...
        public bool Store(MemoryStream _buf_)
        {
            try
            {
                if (false == XXVector2_Serializer.Store(_buf_, Direction)) { return false; }
                _buf_.Write(BitConverter.GetBytes(Velocity), 0, sizeof(float));
            }
            catch (System.Exception)
            {
                return false;
        ...
        public bool Load(MemoryStream _buf_)
        {
            try
            {
                if (false == XXVector2_Serializer.Load(ref Direction, _buf_)) { return false; }
                if (sizeof(float) > _buf_.Length - _buf_.Position) { return false; }
                Velocity = BitConverter.ToSingle(_buf_.GetBuffer(), (int)_buf_.Position);
                _buf_.Position += sizeof(float);
            }
            catch (System.Exception)
            {
